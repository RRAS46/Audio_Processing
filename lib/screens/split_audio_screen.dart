...
class SplitAudioModePage extends StatefulWidget {
  @override
  _SplitAudioModePageState createState() => _SplitAudioModePageState();
}

class _SplitAudioModePageState extends State<SplitAudioModePage> {
...
// Function to upload the JSON file to Supabase
  ...
  Future<void> insertIntoTable(String timestampz) async {
    ...
    final data = {
      ...
      'command': AudioProcessingMode.vocalSplit.value,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:  !_isProcessing ? AppBar(title: Text('Split Audio')) : null,
      body: Center(
