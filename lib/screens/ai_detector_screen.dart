...
class AiDetectorModePage extends StatefulWidget {
  @override
  _AiDetectorModePageState createState() => _AiDetectorModePageState();
}

class _AiDetectorModePageState extends State<AiDetectorModePage> {
...
// Function to upload the audio file to Supabase
  ...
  Future<void> insertIntoTable(String timestampz) async {
    ...
    final data = {
      ...
      'annotations_name' : "",
      'command': AudioProcessingMode.aiRecognition.value,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:  !_isProcessing ? AppBar(title: Text('Audio Ai Detector')) : null,
      body: Center(
