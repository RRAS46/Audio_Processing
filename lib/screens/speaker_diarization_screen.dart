...
class SpeakerDiarizationModePage extends StatefulWidget {
  @override
  _SpeakerDiarizationModePageState createState() => _SpeakerDiarizationModePageState();
}

class _SpeakerDiarizationModePageState extends State<SpeakerDiarizationModePage> {
...
// Function to upload the JSON file to Supabase
  ...
  Future<void> insertIntoTable(String timestampz) async {
    ...
    final data = {
      ...
      'command': AudioProcessingMode.speakerDiarization.value,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:  !_isProcessing ? AppBar(title: Text('Speaker Diarization')) : null,
      body: Center(
